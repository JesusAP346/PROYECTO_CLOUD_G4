...
def menu_comun(user: Dict) -> None:
    while True:
        ...
        print("6) Duplicar topología propia")
        print("7) Exportar topología")
        print("8) Importar topología")
        print("9) Ver límites de recursos (rol)")
        ...
        elif op == 6: duplicate_topology(user)
        elif op == 7: export_topology(user)
        elif op == 8: import_topology(user)
        elif op == 9: show_resource_limits(user)
        elif op == 0: break
...
def menu_admin(user: Dict) -> None:
    while True:
        ...
        print("6) Duplicar topología propia")
        print("7) Monitoreo (todas las topologías)")
        print("8) Gestión de usuarios")
        print("9) Gestión de plantillas")
        print("10) Exportar topología")
        print("11) Importar topología")
        print("12) Ver límites de recursos (rol)")
        print("0) Cerrar sesión")
        op = read_int("\nElige opción: ", 0, 12)
        ...
        elif op == 7: monitor_all_topologies(user)
        elif op == 8: manage_users(user)
        elif op == 9: manage_templates(user)
        elif op == 10: export_topology(user)
        elif op == 11: import_topology(user)
        elif op == 12: show_resource_limits(user)
        elif op == 0: break
